variable "app_name" {
  ...
  type = "string"
  default = "testnewmobile-dev-1517"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "testnewmobile-dev-1517.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/testnewmobile-dev-1517/archive/master.tar.gz"
}
